...
// 타입속석명? 선택적속성 (Optional Property)을 선언하는것으로
// 선택적 속성을 선언된 타입을 사용할대 해당 선택적 옵션을 사용해도 되고 안해도 될수 있게 하는 기능을 지원
...
export default function BlogCreate() {
    ...
    // 타입스크립트에서의 any 타입으로 지정하면 타입에러를 발생시지키 않는다.
    // 타입을 지정하기 애매한 경우 주로 any타입으로 지정해서 타입스크립트 에러릴 피해갈수있게 사용하는 타입
